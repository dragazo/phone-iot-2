...
sealed class DartCommand with _$DartCommand {
  ...
  const factory DartCommand.setColor({
    required DartRequestKey key,
    required String id,
    required ColorInfo primary,
    required ColorInfo secondary,
  }) = DartCommand_SetColor;
...
sealed class DartValue with _$DartValue {
  ...
  const factory DartValue.number(
    double field0,
  ) = DartValue_Number;
...
sealed class RustCommand with _$RustCommand {
  ...
  const factory RustCommand.injectMessage({
    ...
    required List<(String, DartValue)> values,
