...
TextAlignInfo textAlignFromBEBytes(Uint8List src) {
  ...
  switch (src[0]) {
    case 1:
      return TextAlignInfo.Center;
    case 2:
      return TextAlignInfo.Right;
    default:
      return TextAlignInfo.Left;
  }
}
...
ButtonStyleInfo buttonStyleFromBEBytes(Uint8List src) {
  ...
  switch (src[0]) {
    case 1:
      return ButtonStyleInfo.Ellipse;
    case 2:
      return ButtonStyleInfo.Square;
    case 3:
      return ButtonStyleInfo.Circle;
    default:
      return ButtonStyleInfo.Rectangle;
  }
}
...
TouchpadStyleInfo touchpadStyleFromBEBytes(Uint8List src) {
  ...
  switch (src[0]) {
    case 1:
      return TouchpadStyleInfo.Square;
    default:
      return TouchpadStyleInfo.Rectangle;
  }
}
...
SliderStyleInfo sliderStyleFromBEBytes(Uint8List src) {
  ...
  switch (src[0]) {
    case 1:
      return SliderStyleInfo.Progress;
    default:
      return SliderStyleInfo.Slider;
  }
}
...
ToggleStyleInfo toggleStyleFromBEBytes(Uint8List src) {
  ...
  switch (src[0]) {
    case 1:
      return ToggleStyleInfo.Checkbox;
    default:
      return ToggleStyleInfo.Switch;
  }
}
...
ImageFitInfo imageFitFromBEBytes(Uint8List src) {
  ...
  switch (src[0]) {
    case 1:
      return ImageFitInfo.Zoom;
    case 2:
      return ImageFitInfo.Stretch;
    default:
      return ImageFitInfo.Fit;
  }
}
...
Future<Uint8List> packageImageForUdp(ui.Image img) async {
  final rawEncoded = (await img.toByteData(format: ui.ImageByteFormat.rawRgba))!
      .buffer
      .asUint8List();
  image.Image wrapped = image.Image.fromBytes(
      width: img.width,
      height: img.height,
      bytes: rawEncoded.buffer,
  ...
  if (rawBytes > maxImageBytes) {
    ...
    wrapped = image.copyResize(wrapped,
  ...
  print(
      'encoded ${img.width}x${img.height} image as ${wrapped.width}x${wrapped.height} in ${res.lengthInBytes} bytes');
  return res;
}
